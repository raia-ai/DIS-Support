...
short_description: "A chapter from the DIS Business System Manual about APPENDIX B."
long_description: "This document is a chapter from the DIS Business System Manual, focusing on APPENDIX B."
---

## FORMS ALIGNMENT EPSON FX 100 PRINTER
...
## APPENDIX B: FORMS ALIGNMENT EPSON FX100 PRINTER
...
## APPENDIX B: FORMS ALIGNMENT EPSON FX 100 PRINTER
...
**C =** To cancel processing, type a C. **DO NOT USE THIS OPTION.** You cannot re-run Print Statements or Print Payables Checks or Payroll unless restore a backup, which means you may have to repeat a lot of work.
...
You may want to save output before printing, in case you are having problems with alignment or would simply like additional copies. The
...
Message ID . . . . . . . :   CPA3394                Severity . . . . . . . . :   99
Message type . . . . . . :   Inquiry                Time sent  . . . . . . . :   10:44:24
Date sent  . . . . . . . :   07/02/97
...
When the register finishes printing, you will receive a message telling you to load checks.

Before you answer the message put the checks in the tractor feed so that they are lined up like this:

**Horizontal Alignment**

The first form will be used for alignment. Make a mark 1/8 inch to the right of the left perforation on the check. Line this mark up with the first mark on the metal bar.

**Vertical Alignment**

Align checks so that the top of the metal bar is even with the center of the second hole up from the bottom of the check stub.
...
When checks have printed, change the printer parameters back to the


correct settings for standard forms.

## RECEIVABLES STATEMENTS AND PAST DUE STATEMENTS
...
The left perforation should be lined up with the 1 (one) on the metal bar.

**Vertical Alignment**

Align the statements so the metal bar is in the center of the second hole up from the bottom of the statement.
...
If statements are aligned as described they should only need minor adjustment. Make minor adjustments using the roll wheel.

When you are satisfied with the alignment, answer the message with a G.


The rest of the statements will print.
